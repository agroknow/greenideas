...
<head>
<title>Green Ideas Pathways <?php echo isset($title) ? ' | ' . strip_formatting($title) : ''; ?></title>
<!-- Meta -->
...
<div style="float:left;"><h1><a href="<?php echo uri('index');?>"><img src="<?php echo uri('themes/natural/images/interface/logo.png'); ?>"></a></h1></div><!--end rx div-->
