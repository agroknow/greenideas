...
<?php echo body_tag(array('id' => @$bodyid, 'class' => @$bodyclass)); ?>
    ...
    <div id="wrap">
        <div id="header">
            <div id="site-title"><?php echo link_to_admin_home_page(__(settings('site_title'))); ?></div>
            ...
            <div id="site-info">
                <?php if (current_user()): ?>
                    ...
                    <?php /*| <a href="http://natural-europe.tuc.gr/dev/newticket" target="_blank"><?php echo __('Report a problem') ?></a> */ ?>
                    </p>
                <?php endif; ?>
