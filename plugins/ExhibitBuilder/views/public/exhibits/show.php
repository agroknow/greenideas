                    ...
                    $(function() {
                        ...
                        function setLightBox(file, size) {
                            ...
                            if (file.metadata.lom.educational != undefined) {
                                ...
                                if (file.metadata.lom.educational.typeOfEvents != undefined && file.metadata.lom.educational.typeOfEvents.value != "") {

                                    if (file.metadata.lom.educational.typeOfEvents instanceof Array) {
                                        var tmpEventType = [];
                                        var tmpEventTypeLabel = "";
                                        $.each(file.metadata.lom.educational.typeOfEvents, function(kk, kv) {
                                            tmpEventType.push(kv.value);
                                            tmpEventTypeLabel = kv.label;
                                        });
                                        imgInText.lb += '<span><b>' + tmpEventTypeLabel + ':</b> ' + tmpEventType.join(', ') + '</span>';

                                    } else {
                                        imgInText.lb += '<span><b>' + file.metadata.lom.educational.typeOfEvents.label + ':</b> ' + file.metadata.lom.educational.typeOfEvents.value + '</span>';
                                    }
...
//
//                                        }
//                                        if (j.metadata.lom.educational.typeOfEvents != undefined) {
//
//                                            if (j.metadata.lom.educational.typeOfEvents instanceof Array) {
//                                                var tmpEVTP = [];
//                                                var tmpEVTPLabel = '';
//                                                $.each(j.metadata.lom.educational.typeOfEvents, function(krt, vrt) {
//                                                    tmpEVTP.push(vrt.value);
//                                                    tmpEVTPLabel = vrt.label;
//                                                });
//
//                                                eText += '<div class="subtitle">' + tmpEVTPLabel + '</div>';
//                                                eText += '<div>' + tmpEVTP.join(', ') + '</div>';
//
//                                            } else {
//                                                eText += '<div class="subtitle">' + j.metadata.lom.educational.typeOfEvents.label + '</div>';
//                                                eText += '<div>' + j.metadata.lom.educational.typeOfEvents.value + '</div>';
//                                            }
//
//                                        }
//
